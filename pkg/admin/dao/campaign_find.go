...
// FindByCondition ...
func (campaignImplement) FindByCondition(ctx context.Context, cond interface{}, opts ...*options.FindOptions) (docs []mgaffiliate.Campaign) {
	var (
...
// CountByCondition ...
func (campaignImplement) CountByCondition(ctx context.Context, cond interface{}) int64 {
	var (
		col = database.CampaignCol()
	)
